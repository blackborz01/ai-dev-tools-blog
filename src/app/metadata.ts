...
export const metadata: Metadata = {
  ...
  description: 'Master AI coding tools like Cursor, GitHub Copilot & Claude. Fix MCP server errors, avoid AI slowdowns, boost developer productivity 10x with proven strategies & real benchmarks.',
  ...
  openGraph: {
    title: 'BoostDevSpeed - Ship Code 10x Faster with AI',
